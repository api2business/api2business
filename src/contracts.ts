export type AppCommand =
  ...
  | { kind: "upstream.apikey.cutoff"; phase: "start" | "disable" | "guard" | "restore"; operationId: string; durationSeconds: number; accountIds?: number[]; trigger?: "manual" | "account-import" | "bugteam-import" | "public-recovery" | "external-error"; restoreReason?: string; mode?: "live" | "dryrun"; requestId?: string; matchedKeyword?: string }
